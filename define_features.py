...
Returns:
    ...
    @cyclical_variables - list with string names with cyclical variables (e.g. month of year)
...
def define_features(model_complex='fourth',
    ...
    try:
        ...
        #cyclical and OHE variables shuld be the same for basic and full model
        ...
        if col_target=='pax_seat' or col_target=='revenue_tickets':
            #basic models
            cols_features_basic_120d = [
            ...
            cols_features_basic_63d = cols_features_basic_120d  + [u'lf_063', u'yield_tickets_063', u'avg_price_ticket_063_092']
            cols_features_basic_45d = cols_features_basic_63d   + [u'lf_045', u'yield_tickets_045', u'avg_price_ticket_045_062']
            cols_features_basic_32d = cols_features_basic_45d   + [u'lf_032', u'yield_tickets_032', u'avg_price_ticket_032_044']
            cols_features_basic_14d = cols_features_basic_32d   + [u'lf_014', u'yield_tickets_014', u'avg_price_ticket_014_031']
            cols_features_basic_7d  = cols_features_basic_14d   + [u'lf_007', u'yield_tickets_007', u'avg_price_ticket_007_013'] 
            #create list with lists with features for each of the consecutive models
            features_list_basic_model = [cols_features_basic_7d,  cols_features_basic_14d, cols_features_basic_32d,
                                         cols_features_basic_45d, cols_features_basic_63d, cols_features_basic_120d]
            #full models
            if model_complex=='fourth':   
                cols_features_120d = [
                 ...
                 'sum_pax_seat_by_cd_airport_pair','sum_revenue_tickets_by_cd_airport_pair'
                ] 
                cols_features_63d = cols_features_120d + [u'lf_063', u'yield_tickets_063', u'avg_price_ticket_063_092', 'pax_from_views_063', 
                ...
                #create list with lists with features for each of the consecutive models
                features_list = [cols_features_7d, cols_features_14d, cols_features_32d, cols_features_45d, cols_features_63d, cols_features_120d]
            #elif model_complex=='basic':
            #    ohe_variables_in = []
            #    features_list = features_list_basic_model
        #define features for ancillaries predictions
        elif col_target=='ancis':   
            #basic models
            cols_features_basic_120d = [
             u'seats', u'km', u'airport_pair_frequency_day',
            ...
            cols_features_basic_63d = cols_features_basic_120d + [u'lf_063', u'yield_ancis_063', u'avg_price_ticket_063_092']
            cols_features_basic_45d = cols_features_basic_63d   + [u'lf_045', u'yield_ancis_045', u'avg_price_ticket_045_062']
            cols_features_basic_32d = cols_features_basic_45d   + [u'lf_032', u'yield_ancis_032', u'avg_price_ticket_032_044']
            cols_features_basic_14d = cols_features_basic_32d   + [u'lf_014', u'yield_ancis_014', u'avg_price_ticket_014_031']
            cols_features_basic_7d  = cols_features_basic_14d   + [u'lf_007', u'yield_ancis_007', u'avg_price_ticket_007_013']
            #create list with lists with features for each of the consecutive models
            features_list_basic_model = [cols_features_basic_7d,  cols_features_basic_14d, cols_features_basic_32d,
                                         cols_features_basic_45d, cols_features_basic_63d, cols_features_basic_120d]
            #full models
            cols_features_120d = [
             ...
             'competition_similarity',
             'vy_2h_market_share', 'vy_2h_lowcost_market_share', 'vy_2h_seats_market_share', 'vy_2h_lowcost_seats_market_share',
             'sum_ancis_by_cd_airport_pair'
            ] 
            cols_features_63d = cols_features_120d + [u'lf_063', u'yield_ancis_063', u'avg_price_ticket_063_092', 'pax_from_views_063', 
                                                       'min_price_ticket_2h_competition_063_092', 'max_price_ticket_2h_competition_063_092', 'avg_price_ticket_2h_competition_063_092']
            ...
            cols_features_7d  = cols_features_14d   + [u'lf_007', u'yield_ancis_007', u'avg_price_ticket_007_013', 'pax_from_views_007',                                                    
                                                       'min_price_ticket_2h_competition_007_013', 'max_price_ticket_2h_competition_007_013', 'avg_price_ticket_2h_competition_007_013']
            #create list with lists with features for each of the consecutive models
            features_list = [cols_features_7d, cols_features_14d, cols_features_32d,
                             cols_features_45d, cols_features_63d, cols_features_120d]
